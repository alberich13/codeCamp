package com.indigo.restapi.exception.handler;
...
import com.indigo.restapi.exception.FieldErrorDto;
 ...
 *
 */
@ControllerAdvice(basePackages = {"com.indigo.restapi.controller"} )
@Slf4j
